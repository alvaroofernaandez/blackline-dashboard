            ...
            {noticias.map((fila, index) => (
              ...
              >
                ...
                <td className="flex gap-3 justify-center items-center p-2">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-square-pen-icon lucide-square-pen w-4 h-4 mx-auto"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z"/></svg>
                  </button>
                  <button
                    type="button"
          ...
          <div key={fila.id} className="bg-white rounded-xl shadow border p-4 flex flex-col gap-2">
            <div className="flex items-center gap-3">
              <img
                src={fila.imagen_url}
                alt="Imagen de noticia"
                className="w-16 h-full object-cover rounded-lg border"
              />
              <div>
                <h3 className="font-semibold text-lg text-neutral-700">{fila.titulo}</h3>
                <p className="text-xs text-neutral-500">{formatearFecha(fila.fecha)}</p>
              </div>
            </div>
            <p className="text-neutral-600 text-sm mt-2">{fila.descripcion}</p>
            <div className="flex gap-3 justify-end mt-2">
              <button
                type="button"
                aria-label="Editar noticia"
                className="bg-neutral-400 size-10 hover:scale-105 transition-all duration-500 text-white rounded-lg flex items-center justify-center"
                onClick={() => navigate(`/actualizar-noticia/${fila.id}`)}
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-square-pen-icon lucide-square-pen w-4 h-4 mx-auto"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z"/></svg>
              </button>
              <button
                type="button"
                aria-label="Eliminar noticia"
                className="bg-neutral-600 dark:bg-neutral-800 size-10 hover:scale-105 transition-all duration-500 text-white rounded-lg flex items-center justify-center"
                onClick={() => abrirModal(fila.id)}
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-trash2-icon lucide-trash-2 w-4 h-4 mx-auto"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/></svg>
              </button>
